...
interface UsernameApi {
    ...
    @Operation(
        summary = "変更",
        operationId = "requestChangeLoginId_0",
    ...
    fun requestChangeLoginId_0(@Parameter(description = "", required = true) @Valid @RequestBody changeUsername: ChangeUsername): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
}
